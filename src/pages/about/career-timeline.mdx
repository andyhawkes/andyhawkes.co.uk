...
export const timelineEntries = [
  {
    ...
    projects: {
      ...
      annotations: [
        "Personal experiments, self-teaching, and a pro bono rebuild of the website for a food company I worked for in the late 90s opened the door to a career that I couldn't have imagnined at the time"
      ],
    },
  },
  {
