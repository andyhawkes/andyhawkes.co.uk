...
export const timelineEntries = [
  ...
  },
  {
    ...
    work: {
      title: 'Deltatre',
      annotations: [
        'Joined as one of a small team of Technical Directors delivering major projects, stepped up to grow and run a team of 12 TDs, took on engineering best practice across the orgaisation, and am now VP Product Engineering and Architecture, focused on technical leadership, engineering alignment, and pragmatic delivery in a world where consumer expectations are set by the R&D budgets of Netflix, Amazon Prime, and Apple TV.',
      ],
    },
    projects: {
      annotations: [
...
My career to date has been shaped more by curiosity and opportunity than by planning — I followed interesting problems, took on things that scared me slightly, and ended up covering a lot of ground as a result.
