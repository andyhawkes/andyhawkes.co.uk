...
You are using _someone else’s AI_.
...
AI systems are not just tools, they're interfaces to capability, and whoever controls that interface controls:
...
Corey Doctorow’s concept of “enshitification” describes how platforms evolve:

1. Good to users  
2. Good to business customers  
3. Good to themselves  

AI platforms are not immune to this pattern, and the incentives may accelerate it.
...
Not in terms of runaway AI systems, but in terms of something more immediate — the possibility that AI accelerates the concentration of economic and decision-making power in ways we have not seen before.
